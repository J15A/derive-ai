...
export default function WhiteboardApp(): JSX.Element {
  ...
  return (
    <div className="h-screen overflow-hidden">
      <div
        className={`mx-auto grid h-full min-h-0 max-w-[1800px] grid-cols-1 gap-2 ${
      ...
      >
        ...
        {isPhone ? (
          <button
            ...
            className="fixed left-0 top-1/2 z-[100] flex h-16 w-7 -translate-y-1/2 items-center justify-center rounded-r-2xl border border-l-0 border-slate-200 bg-panel text-slate-500 shadow-soft transition-all duration-200 hover:w-8 hover:bg-slate-50 hover:text-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500"
            title={sidebarCollapsed ? "Open notes" : "Close notes"}
            type="button"
            aria-label={sidebarCollapsed ? "Open notes" : "Close notes"}
          >
        ...
        {!isPhone && sidebarCollapsed && (
          <button
            ...
            className="fixed left-0 top-1/2 z-[80] flex h-24 w-8 -translate-y-1/2 items-center justify-center rounded-r-2xl border border-l-0 border-slate-200 bg-panel text-slate-500 shadow-soft transition-all duration-200 hover:w-10 hover:bg-slate-50 hover:text-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500"
            title="Open sidebar"
            type="button"
