  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-6">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-600">Redirecting to account creation...</p>
        <button
          type="button"
          className="mt-6 w-full rounded-lg bg-cyan-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-cyan-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500"
          onClick={() =>
            void loginWithRedirect({
              authorizationParams: { screen_hint: "signup" },
              appState: { returnTo: "/app" },
